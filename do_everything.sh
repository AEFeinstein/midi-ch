...
mv "./midis/Mattmattat - Dance of the Cremulons (FINAL FOR REALSIES).mid" "./midis/sh_cremulons.mid"
...
mv "./midis/Ronin Op F - Starfest Magway (FINAL FOR REALSIES).mid" "./midis/sh_starfest.mid"
